...
export default function GeographyPanel({layers,onLayers,status,selected,summit,range,country,bounds,onSelect,onFocus,onPeak,onRange,onClear,onRetry,busy,open,onOpen,query,onQuery,onFlood}:Props){
