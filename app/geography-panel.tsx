...
import { ArrowLeft, ArrowUpRight, Check, ChevronDown, ChevronRight, Droplets, House, Mountain, Waves, X } from 'lucide-react';
...
type Props = {
  ...
  onSelect:(place:PlaceEntry)=>void; onPeak:(peak:Peak)=>void; onRange:(range:Range)=>void;
...
export default function GeographyPanel({layers,onLayers,status,selected,summit,range,country,bounds,onSelect,onPeak,onRange,onClear,onRetry,busy,open,onOpen,query,onQuery,onFlood}:Props){
